...
describe('test adding another item to todo list', ()=>{
    it ('should return add another item name', async ()=>{
        ...
        .sendKeys('Learn Mocha', Key.RETURN)
        ...
        todoText.should.equal('Learn Mocha')
